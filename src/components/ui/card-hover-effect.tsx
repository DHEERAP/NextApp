...
// Define the type for motion.span with custom props
type MotionSpanProps = MotionProps & React.HTMLProps<HTMLSpanElement>;

// Create a custom motion.span component with the above type
